...
const GAMES_DATA = [
  ...
  { name: 'Coin Run', slug: 'coin_run', image: 'coinrun.avif', description: 'Prediction Coin Run avec machine learning', color: 'bg-pink-500', icon: 'Coins', unlockType: 'referral', unlockValue: 30, tier: 6, sortOrder: 10, showOnLanding: false },
